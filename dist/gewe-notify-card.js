(function () {
  ...
  class GeweNotifyCard extends r {
    ...
    handleUsernameClick(userName) {
      alert("You clicked on ".concat(userName, "'s profile!"));
    ...
    render() {
      ...
      return x(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n      <ha-card class=\"card\">\n        <h1>Contacts</h1>\n\n        <div class=\"filter-container\">\n          <input\n            class=\"filter-input\"\n            type=\"text\"\n            .value=\"", "\"\n            @input=\"", "\"\n            placeholder=\"Filter by userName, nickName, or remark\"\n          />\n        </div>\n\n        <div class=\"tab-container\">\n          <div class=\"tab ", "\" @click=\"", "\">\n            Friends\n          </div>\n          <div class=\"tab ", "\" @click=\"", "\">\n            Chatrooms\n          </div>\n        </div>\n\n        <table>\n          <thead>\n            <tr>\n              ", "\n            </tr>\n          </thead>\n          <tbody>\n            ", "\n          </tbody>\n        </table>\n\n        <div class=\"pagination\">\n          ", "\n          <span>Page ", " of ", "</span>\n          ", "\n        </div>\n      </ha-card>\n    "])), this.filterText, this.handleFilterChange, this.currentTab === 'friends' ? 'active' : '', () => this.handleTabChange('friends'), this.currentTab === 'chatrooms' ? 'active' : '', () => this.handleTabChange('chatrooms'), columnNames.map(column => x(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["<th>", "</th>"])), column)), currentPageDataSlice.map(item => x(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n              <tr>\n                <td><img class=\"avatar\" src=\"", "\" alt=\"avatar\" /></td>\n                <td @click=\"", "\" class=\"clickable\">", "</td>\n                <td>", "</td>\n                <td>", "</td>\n              </tr>\n            "])), item.smallHeadImgUrl || '/hacsfiles/gewe-notify-card/images/default-avatar.png', () => this.handleUsernameClick(item.userName), item.userName, item.nickName, item.remark)), this.page > 1 ? x(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n            <button class=\"page-button\" @click=\"", "\">Previous</button>\n          "])), () => this.handlePageChange(this.page - 1)) : '', this.page, totalPages, this.page < totalPages ? x(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n            <button class=\"page-button\" @click=\"", "\">Next</button>\n          "])), () => this.handlePageChange(this.page + 1)) : '');
    }
  }
